			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Regulated United Europe</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Regulated United Europe</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>KML File</h1>
															...
															<p>
									This KML Fiile is generated by the Rank Math WordPress SEO Plugin. It is used to provide location information to Google.								</p>
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://regulatedunitedeurope.github.io/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
